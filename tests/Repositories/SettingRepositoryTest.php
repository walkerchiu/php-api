...
use WalkerChiu\API\Models\Repositories\SettingRepository;
...
class SettingRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    protected function getPackageProviders($app)
    {
        return [\WalkerChiu\Core\CoreServiceProvider::class,
                \WalkerChiu\API\APIServiceProvider::class];
    }
    ...
    public function testSettingRepository()
    {
        ...
        Config::set('wk-api.onoff.core-lang_core', 0);
        Config::set('wk-core.lang_log', 1);
        Config::set('wk-api.lang_log', 1);
        Config::set('wk-core.soft_delete', 1);
        Config::set('wk-api.soft_delete', 1);
     ...
     *     WalkerChiu\API\Models\Repositories\SettingRepository
     * 
     * @return void
     */
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(Setting::class)->create();
            $db_morph_2 = factory(Setting::class)->create();
            $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
    ...
    public function testAutoComplete()
    {
        ...
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
